...
import configure, qfilter, gbloader, subtraction, statistics, fasta, intersect, project, sample, alignment
...
def log(args):
    ...
    try:
        os.makedirs(os.path.expanduser('~/.capsid'))
    except OSError, e:
    ...
    file_handler = logging.handlers.RotatingFileHandler(os.path.expanduser('~/.capsid/capsid.log'))
...
__version__ = get_version((1, 5, 0, "a", 1, 0))
